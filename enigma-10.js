...
// Enigma aqui!
const enigma =
  "Um livro tem páginas numeradas de 1 a 100. Quantas vezes aparece o número 1? (Número)";
const salt = "halloween_salt_2025";
const iterations = 100000;
const storedHash = "rKdtDvPeGv6SjN69T3Tox4UuBiiGX9QKKV0bnin6osU=";
...
function tentarApagarArquivo() {
  ...
  const possibleFiles = files.filter(
    (f) => f !== "enigma-10.js" && f.endsWith(".js")
  );
