...
// Enigma aqui!
const enigma =
  "Você entra numa sala e não há nada, mas algo se move. O que é? (Palavra)";
const salt = "halloween_salt_2025";
const iterations = 100000;
const storedHash = "yTIVLvNlOsQHk+FTtGkxMD2Rz1Rjs+swaDQLN+NkK/U=";
